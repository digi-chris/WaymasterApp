function waymasterUI() {
    ...
    this.drawString = function(text, col, row, backgroundColor, foregroundColor, drawOnOverlay, webControl) {
    ...
    this.drawRectangle = function(fromCol, fromRow, toCol, toRow, backgroundColor, foregroundColor, lineStyle, fill, onOverlay, webControl) {
        ...
        for (var f = 0; f < 2; f++) {
            ...
            for (var i = 0; i < 256; i++) {
                ...
                for (var foregroundColor = 0; foregroundColor < 16; foregroundColor++) {
                    ...
                    document.getElementById("charCache").appendChild(c);
    ...
    function initWebControls() {
        ...
        var upBtn = new TextButton(69, 18, String.fromCharCode(24), tobj);
        var downBtn = new TextButton(69, 21, String.fromCharCode(25), tobj);
        var rightBtn = new TextButton(74, 21, String.fromCharCode(26), tobj);
        var leftBtn = new TextButton(64, 21, String.fromCharCode(27), tobj);

        var zoomInBtn = new TextButton(74, 1, "+", tobj);
        var zoomOutBtn = new TextButton(74, 4, "-", tobj);
